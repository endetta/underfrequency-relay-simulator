...
node tools/sld.test.js       # 29 asersi geometri SLD (gen atas / beban bawah / CB 12×12 / kotak tak tumpuk / F1–F3)
...
Total **161 asersi**, semuanya hijau di Node ≥ 22 (tanpa dependensi). `tools/shoot.js`
