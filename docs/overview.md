...
node tools/sld.test.js       # 27 asersi geometri SLD (gen atas / beban bawah / CB 12×12 / kotak tak tumpuk / F1–F2)
...
Total **159 asersi**, semuanya hijau di Node ≥ 22 (tanpa dependensi). `tools/shoot.js`
